        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Row(
                ...
                children: [
                  IconPlusText(
                    ...
                    name: app_strings.like,
                  ),
                  IconPlusText(
                      iconName: Icons.comment, name: app_strings.comment),
                  IconPlusText(
                      iconName: Icons.repeat_on_sharp,
                      name: app_strings.repost),
              ...
              Padding(
                padding:
                    EdgeInsets.only(left: screenWidth * app_widths.width16),
                child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    if (index % 2 == 0) {
                      return Padding(
                        padding: EdgeInsets.only(
                            bottom: screenHeight * app_heights.height15),
                        child: Row(
                          children: [
                            Padding(
                              padding: EdgeInsets.only(
                              ...
                              child: Icon(Icons.circle,
                                  size: screenHeight * app_heights.height75),
                            ),
                            Expanded(
                              child: Padding(
                                padding: EdgeInsets.symmetric(
                                    horizontal:
                                        screenWidth * app_widths.width16),
                                child: Container(
                                    height:
                                        screenHeight * app_heights.height130,
                                    decoration: BoxDecoration(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsets.symmetric(
                                          horizontal:
                                              screenWidth * app_widths.width10,
                                              ...
                                              Text(
                                                ...
                                                style: TextStyle(
                                                    ...
                                                    fontSize: screenHeight *
                                                        app_heights.height24),
                                              ),
                                              Icon(
                                                Icons.more_horiz_outlined,
                                                size: screenHeight *
                                                    app_heights.height35,
                                              ),
                                            ],
                                          ),
                                          Text(
                      ...
                      return Padding(
                        ...
                        child: Row(
                          children: [
                            Padding(
                              padding: EdgeInsets.only(
                                left: screenWidth * app_widths.width60,
                              ),
                              child: Icon(Icons.circle,
                                  size: screenHeight * app_heights.height60),
                            ),
